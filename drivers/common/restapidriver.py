...
@authors: sudheer(sudheer@paxterrasolutions.com)
...
class RESTAPI(Component):
    '''
        This will define common functions for RESTAPI included.
    '''
    def __init__(self):
    ...
    def connect(self,**connectargs):
        ...
        connect_result = super(RESTAPI, self).connect()
    ...
    def disconnect(self):
        result = super(RESTAPI, self).disconnect(self)
        result = main.TRUE
    ...
    def execute(self, **execparams):
        ...
        '''
        result = super(RESTAPI, self).execute(self)
        defaultPrompt = '.*[$>\#]'
